...
5. Enter the following URL and click **Add**: ```text
[https://github.com/dimzki/Runtime-Global-Admin-Panel.git](https://github.com/dimzki/Runtime-Global-Admin-Panel.git)
\```
